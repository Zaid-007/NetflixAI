      ...
      {movieDetail && (
        <div className="bg-[#181818] min-h-full sm:-mt-14">
          <div className="z-10 ">
            ...
            />
            <div className="sm:w-[55%] sm:h-fit pt-[12%] px-6 sm:px-16 relative bg-[#181818] sm:bg-transparent sm:bg-gradient-to-r sm:from-[#181818] sm:from-30% shadow-[0_35px_15px_55px_rgb(24,24,24)] sm:shadow-none">
